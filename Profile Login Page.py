...
class userDB():
    def __init__(self):
        self._username = "James"
        self._password = "James76*"
        self.captcha = "A7d"
        
    def showUser(self):
        label_show_name["text"] = "Name:" +self._username
        label_show_password["test"] = "Password:" +self._password
        label_show_captcha["text"] = "Captcha:" +self._captcha
